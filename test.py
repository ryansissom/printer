...
# ZPL content to be sent to the printer
zpl_content = """
^XA
^PW406
^LL203
...
def send_zpl_file_to_printer(zpl_data, printer_name):
    """Send ZPL data to the specified printer."""
    zpl_file = "/tmp/label.zpl"
    ...
    os.system(f"lp -P '{printer_name}' {zpl_file}")
